...
## NOT FINISHED
This converter converts about 89% of the map file. So, it will never actually work in a car unless you have the 100% AND the files must be valid. The parts that are missing should be indicated in the code with a `TODO:` comment
